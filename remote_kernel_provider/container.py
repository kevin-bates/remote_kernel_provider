...
from .lifecycle import RemoteLifecycleManager
...
class ContainerLifecycleManager(RemoteLifecycleManager):
    """Kernel lifecycle management for container-based kernels."""
    def __init__(self, kernel_manager, lifecycle_config):
        super(ContainerLifecycleManager, self).__init__(kernel_manager, lifecycle_config)
        self.container_name = ''
    ...
    def launch_process(self, kernel_cmd, **kwargs):
        ...
        super(ContainerLifecycleManager, self).launch_process(kernel_cmd, **kwargs)
    ...
    def send_signal(self, signum):
        ...
        if signum == 0:
            ...
            return super(ContainerLifecycleManager, self).send_signal(signum)
    ...
    def cleanup(self):
        ...
        self.kill()
        super(ContainerLifecycleManager, self).cleanup()
    ...
    def get_lifecycle_info(self):
        ...
        lifecycle_info = super(ContainerLifecycleManager, self).get_lifecycle_info()
    ...
    def load_lifecycle_info(self, lifecycle_info):
        ...
        super(ContainerLifecycleManager, self).load_lifecycle_info(lifecycle_info)
